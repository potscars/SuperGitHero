...
/**
 * Created by MSD Hainizam on 1/27/2016.
 */
public class Register_schoolApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FancyButton btnSignUp = (FancyButton) findViewById(R.id.btn_signup);
